...
// FIX: Use REACT_APP_API_URL from Vercel environment variables.
    ...
    if (error.response?.status === 401 && !originalRequest._retry) {
      ...
      try {
        ...
        if (!refreshToken) {
          ...
          // FIX: Added return so code doesn't continue after redirect
        ...
        clearLocalAuth();
        window.location.href = '/login';
        // FIX: Added return to prevent further execution after redirect
