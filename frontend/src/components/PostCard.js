...
// Safe date formatter — never throws, returns fallback if date is null/invalid
...
function PostCard({ post }) {
  // Guard: if post data is incomplete, render nothing rather than crash
      ...
      <Card.Body>
        ...
        <div className="post-meta">
          <div className="author-info">
            {/* FIX: was post.author.profile.avatar — crashes if profile is null */}
        ...
        <div className="mt-2">
          <small className="text-muted">
            {/* FIX: format(new Date(null)) throws — use safeFormat with fallback */}
